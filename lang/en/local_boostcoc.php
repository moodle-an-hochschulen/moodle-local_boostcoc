...
$string['setting_addusagehint'] = 'Add usage hint';
$string['setting_addusagehint_desc'] = 'Enabling this setting will add a node to the mycourses list in Boost\'s nav drawer telling the user why the mycourses list looks as it is (e.g. why filtered and hidden courses are visible here respectively where to change the filters and hidden courses).';
...
$string['usagehintnotshowenabledactivefilters'] = 'Active course filters:';
$string['usagehintnotshowenablednoactivefilters'] = 'No active course filters';
$string['usagehintnotshowenabledchangenotshown'] = 'Change filters or re-show hidden courses';
$string['usagehintnotshowdisabled'] = 'This course list shows all courses which you are enrolled in. Filters and hidden courses are not applied.';
